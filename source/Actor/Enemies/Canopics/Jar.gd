...
@onready var atkbox = $Mesh_Jar/Mesh/Skeleton3D/BoneAttachment3D/Atkbox_Light/CollisionShape3D
...
func _on_hitbox_area_entered(area):
	match(area.name):
		#Sword
		"Slash": damage(100 + G.sword_damage)
		"Chop": damage(100 + G.sword_damage)
		"Thrust": damage(100 + G.sword_damage)
		"Soulblast": damage(100 + G.sword_damage)
#Shatter
func shatter(): 
	var p = get_parent()
	#Create Fragments
